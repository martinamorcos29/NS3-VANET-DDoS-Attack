...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("5VanetDdosHighwayNodesFixed");
...
int main(int argc, char* argv[]) {
    ...
    sink2->Configure(ipRSU2, normalDstPort, "rsu2_5attackers.csv");
    ...
    attackers = {0, 5, 10, 15, 20};   // 5 attackers
    ...
    const std::string xmlFile = "5 attackers_vanet.xml";
