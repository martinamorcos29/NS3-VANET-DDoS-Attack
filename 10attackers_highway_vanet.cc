...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("10VanetDdosHighwayNodesFixed");
...
int main(int argc, char* argv[]) {
    ...
    sink2->Configure(ipRSU2, normalDstPort, "rsu2_10attackers.csv");
    ...
    attackers = {0, 4, 8, 12, 16, 20, 24, 28, 32, 36};   // 10 attackers
    ...
    const std::string xmlFile = "10attackers_vanet.xml";
    ...
    phy.EnablePcapAll("10_attackers_vanet");
